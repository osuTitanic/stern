...
WIKI_REPOSITORY_OWNER = os.environ.get('WIKI_REPOSITORY_OWNER')
WIKI_REPOSITORY_NAME = os.environ.get('WIKI_REPOSITORY_NAME')
WIKI_REPOSITORY_BRANCH = os.environ.get('WIKI_REPOSITORY_BRANCH')
WIKI_REPOSITORY_PATH = os.environ.get('WIKI_REPOSITORY_PATH')
