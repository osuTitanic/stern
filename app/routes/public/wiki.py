...
def home_wiki_page(language: str):
    ...
    with app.session.database.managed_session() as session:
        return utils.render_template(
            ...
            css='wiki.css',
            title='Wiki',
            site_title='Wiki - Titanic!',
            site_description='Browse through Titanic! wiki articles',
...
def wiki_search_page(language: str):
    ...
    return utils.render_template(
        ...
        css='wiki.css',
        title=f'{query or "Search"} - Wiki',
        site_title=f'{query or "Search"} - Titanic! Wiki',
        site_description='Search the Titanic! wiki',
...
def wiki_page(path: str, language: str = config.WIKI_DEFAULT_LANGUAGE):
    ...
    with app.session.database.managed_session() as session:        
        ...
        return utils.render_template(
            ...
            title=f'{entry.title} - Wiki',
            site_title=f'{entry.title} - Titanic! Wiki',
            site_description=f'Titanic » Wiki » {entry.title}',
